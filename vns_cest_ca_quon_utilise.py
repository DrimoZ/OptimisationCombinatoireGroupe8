...
def generate_all_neighbors(pattern, num_changes, percentage=0.001):
...
def local_search(M, current_pattern):
    ...
    for _ in range(5):
        neighbors = generate_all_neighbors(current_pattern, num_changes=1)  
...
def simulated_annealing(M, P, T=1000.0, cooling_rate=0.9995, max_iter=5000):
    """
